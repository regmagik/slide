...
In 2023 Boris built web site for online check-in before visiting doctor's office
...
- The answer used to be *Compress First then Encrypt* ...
- Because compression is not effective on encrypted data
- However...
...
--- 
# However
- Around 2012 researchers found a way to break encryption in some scenarios involving compression of HTTPS traffic
