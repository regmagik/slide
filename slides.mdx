...
- However, around 2012 researchers found a way to break encryption in some scenarios
- See [CRIME and BREACH attacks](https://en.wikipedia.org/wiki/CRIME)
- It's more secure to Encrypt, and DO NOT Compress
